<?php require '../config/config.php'; if($_SESSION['level'] != 'admin') die('access denied'); ?>
		...
		<div class="row">
			...
			<div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				...
				if (isset($_GET['page'])) {
					...
					if ($page == 'tambah_siswa') {
						include 'pages/siswa/tambah.php';
					}
					if ($page == 'ubah_siswa') {
						include 'pages/siswa/ubah.php';
					}
					if ($page == 'hapus_siswa') {
						include 'pages/siswa/hapus.php';
					}
					...
					if ($page == 'ubah_pengguna') {
						include 'pages/pengguna/ubah.php';
					}
					if ($page == 'hapus_pengguna') {
